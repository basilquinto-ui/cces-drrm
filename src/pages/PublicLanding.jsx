...
export default function PublicLanding() {
  ...
  return (
    <div className="public-page">
      ...
      ].map(([name,phone,email])=><article key={name} className="public-contact-card"><h4>{name}</h4><p>Configurable static content</p><a href={`tel:${phone}`}>Call</a> <a href={`mailto:${email}`}>Email</a> <span className="public-location-placeholder">Location details to be added</span></article>)}</div></section>
      ...
      <section className="public-section"><h3>Public Report Summary</h3><article className="card"><p>Public report summaries will be posted by school DRRM personnel when available.</p><p>Internal report details remain visible only to authorized users.</p></article></section>
